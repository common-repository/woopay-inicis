...
if ( ! class_exists( 'WooPayInicisEmail' ) ) {
	class WooPayInicisEmail extends WC_Email {
		
		public function __construct() {
			$this->id               = 'customer_awaiting_order';
			$this->title            = __( 'Awaiting Payment (Inicis)', 'woopay-core' );
			...
			$this->template_html    = 'emails/woopay-inicis-awaiting-payment.php';
			$this->template_plain   = 'emails/plain/woopay-inicis-awaiting-payment.php';
		...
		public function trigger( $order_id ) {
			...
			if ( $payment_method != 'inicis_virtual' ) {
				return;
			}
